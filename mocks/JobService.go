...
func (_m *JobService) CloseJob(ctx context.Context, jobId int) error {
...
func (_m *JobService) CreateJob(ctx context.Context, job entity.Job) (*int, error) {
...
func (_m *JobService) FindAllJob(ctx context.Context) ([]entity.Job, error) {
	ret := _m.Called(ctx)
...
func (_m *JobService) SetExpiredDate(ctx context.Context, data dto.Expiry) error {
...
func (_m *JobService) SetQuota(ctx context.Context, data dto.Quota) error {
	ret := _m.Called(ctx, data)
